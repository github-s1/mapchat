...
<head>
	...
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/datetimepicker.js"></script>
...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Заказы', 'url'=>array('/admin/orders/order_archive')),
				array('label'=>'Водители', 'url'=>array('/admin/drivers/index')),
				array('label'=>'Клиенты', 'url'=>array('/admin/customers/index')),
