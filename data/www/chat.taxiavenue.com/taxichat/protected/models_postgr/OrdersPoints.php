...
class OrdersPoints extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_order, id_adress, entrance', 'numerical', 'integerOnly'=>true),
			array('is_traversed', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			'order' => array(self::BELONGS_TO, 'Orders', 'id_order'),
	...
	public function search()
	{
		...
		$criteria->compare('entrance',$this->entrance);
