...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->labelEx($customer,'photo');?>
		<div class="img_file" style="background-image: url(<?php echo(!empty($customer->photo)?Yii::app()->params['siteUrl'].'/images/users/'.$customer->photo:Yii::app()->params['siteUrl'].'/img/ed_photo.png');?>);">
