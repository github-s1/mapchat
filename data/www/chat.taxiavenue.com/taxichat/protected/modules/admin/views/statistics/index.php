...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/chartScript.js"></script>
	<h1>Статистика</h1>
	<div class="stats">
		<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/statistics/index" class="active">Статистика</a>
		<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/statistics/drivers">Водители</a>
