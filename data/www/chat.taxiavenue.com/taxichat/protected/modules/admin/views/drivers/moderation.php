...
$(document).ready(function() { 
  ...
  <div id="tabs" class="settings_container tarifs">
	...
	<div id="tabs-2" class="pop_tarif_inner clearfix inv_tab "></div>
	...
	<div class="s_c">
		...
		<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/drivers/banned/id/<?=$id?>" class="pop_banned">Забанить</a>
