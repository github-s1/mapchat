...
class PaymentsHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_user, id_type, value, balance, date_create, rating', 'required'),
	...
	public function relations()
	{
		...
		return array(			'user' => array(self::BELONGS_TO, 'Users', 'id_user'),
	...
	// добавляет запись о начислении/списании средств
	...
	// добавляет запись о списании ежедневной\еженедельной комиссии
	...
	// добавляет запись о списании комиссии с заказа
	...
	// добавляет запись о списании штрафа
	...
	// добавляет запись о люом другом списании 
