...
{	public $directory_name = 'cars_temp';
	...
	public function copy_photos(){
		...
		for($i = 1; $i < 8; $i++) {
			if(is_file(Yii::getPathOfAlias('webroot.images').DIRECTORY_SEPARATOR.'cars'.DIRECTORY_SEPARATOR.$this->getAttribute('photo'.$i))) {
				copy(Yii::getPathOfAlias('webroot.images').DIRECTORY_SEPARATOR.'cars'.DIRECTORY_SEPARATOR.$this->getAttribute('photo'.$i), Yii::getPathOfAlias('webroot.images').DIRECTORY_SEPARATOR.$this->directory_name.DIRECTORY_SEPARATOR.$this->getAttribute('photo'.$i));
			}
			
			if(is_file(Yii::getPathOfAlias('webroot.images').DIRECTORY_SEPARATOR.'cars'.DIRECTORY_SEPARATOR.'small'.DIRECTORY_SEPARATOR.$this->getAttribute('photo'.$i))) {
				copy(Yii::getPathOfAlias('webroot.images').DIRECTORY_SEPARATOR.'cars'.DIRECTORY_SEPARATOR.'small'.DIRECTORY_SEPARATOR.$this->getAttribute('photo'.$i), Yii::getPathOfAlias('webroot.images').DIRECTORY_SEPARATOR.$this->directory_name.DIRECTORY_SEPARATOR.'small'.DIRECTORY_SEPARATOR.$this->getAttribute('photo'.$i));
			}
		}	
    }
