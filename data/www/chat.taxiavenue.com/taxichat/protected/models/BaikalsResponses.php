...
class BaikalsResponses extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_driver, id_baikal, response', 'required'),
			array('id_driver, id_baikal, response', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_driver, id_baikal, response', 'safe', 'on'=>'search'),
		);
	}
