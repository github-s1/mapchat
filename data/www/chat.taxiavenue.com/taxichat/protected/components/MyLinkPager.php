...
{
	const CSS_FIRST_PAGE='to_start';
	const CSS_LAST_PAGE='to_final';
	...
	{	
		...
		if(!isset($this->htmlOptions['class']))
			$this->htmlOptions['class']='pagination_cont_but';
	}
	...
	public function run()
	{
		...
		if(empty($buttons))
			return;
		//echo $this->header;
		//print_r($this->htmlOptions); exit;
		/*
		echo('<div class="pagination">
        <div class="pagination_cont_but">
			<a href="#" class="to_start"></a>
			<a href="#" class="prev"></a>
			<div class="pages">Page: <span>1</span>/15</div>
			<a href="#" class="next"></a>
			<a href="#" class="to_final"></a>
			<div class="clear"></div>
        </div>
      </div>');
	  */
	...
	{	
		...
		$buttons[]= '<div class="pages">Page: <span>'.($currentPage + 1).'</span>/'.$pageCount.'</div>';
		// internal pages
		/*
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		return CHtml::link('',$this->createPageUrl($page), array('class'=>$class));
	}
