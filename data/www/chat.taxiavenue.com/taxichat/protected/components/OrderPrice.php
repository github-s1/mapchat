...
class OrderPrice
{	
	// возвращает расстояние полного маршрута
	...
	// возвращает расстояние маршрута по 2-м точкам
	...
	// возвращает цену с учетом скидки клиента
	...
	// возвращает цену с вхождения во временной промежуток
	...
	// возвращает количество бонусов для оплаты
	...
	// возвращает стоимость вхождения в тарифные зоны
