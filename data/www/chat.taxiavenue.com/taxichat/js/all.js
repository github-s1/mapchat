    ...
    if (!a.ui.version) {
        ...
        a.fn.extend({
            ...
            scrollParent: function () {
                var h;
                h = a.browser.msie && /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? this.parents()
                    .filter(function () {
...
(function (a, d) {
    ...
    a.widget.bridge = function (h, g) {
        a.fn[h] = function (i) {
            ...
            b ? this.each(function () {
                ...
                var l = a.data(this, h);
                l ? l.option(i || {})
                    ._init() : a.data(this, h, new g(i, this))
            });
            return j
        }
    };
    ...
    a.Widget.prototype = {
        ...
        _setOption: function (h, g) {
            this.options[h] = g;
            if (h === "disabled") this.widget()[g ? "addClass" : "removeClass"](this.widgetBaseClass + "-disabled ui-state-disabled")
                .attr("aria-disabled",
            g);
            return this
        },
        ...
        _trigger: function (h, g, i) {
            ...
            g = a.Event(g);
            g.type = (h === this.widgetEventPrefix ? h : this.widgetEventPrefix + h)
                .toLowerCase();
            i = i || {};
            if (g.originalEvent) {
    ...
    a.widget("ui.mouse", {
        ...
        _mouseDown: function (c) {
            if (!d) {
                ...
                var e = this,
                    h = c.which == 1,
                    g = typeof this.options.cancel == "string" && c.target.nodeName ? a(c.target)
...
(function (a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _mouseCapture: function (d) {
            var c = this.options;
            if (this.helper || c.disabled || a(d.target)
                .is(".ui-resizable-handle")) return false;
            this.handle = this._getHandle(d);
            if (!this.handle) return false;
            if (c.iframeFix) a(c.iframeFix === true ? "iframe" : c.iframeFix)
                .each(function () {
        ...
        _mouseUp: function (d) {
            this.options.iframeFix === true && a("div.ui-draggable-iframeFix")
                .each(function () {
        ...
        _createHelper: function (d) {
            ...
            d.parents("body")
                .length || d.appendTo(c.appendTo == "parent" ? this.element[0].parentNode : c.appendTo);
        ...
        _setContainment: function () {
            ...
            if (d.containment == "document" || d.containment == "window") this.containment = [d.containment == "document" ? 0 : a(window)
                .scrollLeft() - this.offset.relative.left - this.offset.parent.left, d.containment == "document" ? 0 : a(window)
                .scrollTop() - this.offset.relative.top - this.offset.parent.top, (d.containment == "document" ? 0 : a(window)
                .scrollLeft()) + a(d.containment == "document" ? document : window)
                .width() - this.helperProportions.width - this.margins.left, (d.containment == "document" ? 0 : a(window)
                .scrollTop()) + (a(d.containment == "document" ? document : window)
            ...
            if (!/^(document|window|parent)$/.test(d.containment) && d.containment.constructor != Array) {
                ...
                if (c) {
                    ...
                    var e = a(c)
                        .css("overflow") != "hidden";
                    this.containment = [(parseInt(a(c)
                        .css("borderLeftWidth"), 10) || 0) + (parseInt(a(c)
                        .css("paddingLeft"), 10) || 0), (parseInt(a(c)
                        .css("borderTopWidth"), 10) || 0) + (parseInt(a(c)
                        .css("paddingTop"), 10) || 0), (e ? Math.max(c.scrollWidth, c.offsetWidth) : c.offsetWidth) - (parseInt(a(c)
                        .css("borderLeftWidth"), 10) || 0) - (parseInt(a(c)
                        .css("paddingRight"), 10) || 0) - this.helperProportions.width - this.margins.left - this.margins.right, (e ? Math.max(c.scrollHeight, c.offsetHeight) : c.offsetHeight) - (parseInt(a(c)
                        .css("borderTopWidth"),
                    10) || 0) - (parseInt(a(c)
    ...
    a.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function (d) {
            ...
            if (c.scrollParent[0] != document && c.scrollParent[0].tagName != "HTML") {
                ...
                if (!e.axis || e.axis != "x") if (d.pageY - a(document)
                    .scrollTop() < e.scrollSensitivity) h = a(document)
                    .scrollTop(a(document)
                    .scrollTop() - e.scrollSpeed);
                else if (a(window)
                    .height() - (d.pageY - a(document)
                    .scrollTop()) < e.scrollSensitivity) h = a(document)
                    .scrollTop(a(document)
                    .scrollTop() + e.scrollSpeed);
                if (!e.axis || e.axis != "y") if (d.pageX - a(document)
                    .scrollLeft() < e.scrollSensitivity) h = a(document)
                    .scrollLeft(a(document)
                    .scrollLeft() - e.scrollSpeed);
                else if (a(window)
                    .width() - (d.pageX - a(document)
                    .scrollLeft()) < e.scrollSensitivity) h = a(document)
                    .scrollLeft(a(document)
                    .scrollLeft() + e.scrollSpeed)
            }
    ...
    a.ui.plugin.add("draggable", "snap", {
        start: function () {
            var d = a(this)
                ...
                c = d.options;
            d.snapElements = [];
            a(c.snap.constructor != String ? c.snap.items || ":data(draggable)" : c.snap)
                .each(function () {
                var e = a(this),
                    h = e.offset();
        ...
        drag: function (d, c) {
            for (var e = a(this)
                .data("draggable"), h = e.options, g = h.snapTolerance, i = c.offset.left, b = i + e.helperProportions.width, f = c.offset.top, j = f + e.helperProportions.height, l = e.snapElements.length - 1; l >= 0; l--) {
...
(function (a) {
    ...
    a.ui.intersect = function (d, c, e) {
        ...
        var h = (d.positionAbs || d.position.absolute)
            .left,
            g = h + d.helperProportions.width,
            i = (d.positionAbs || d.position.absolute)
                .top,
        ...
        case "pointer":
            return a.ui.isOver((d.positionAbs || d.position.absolute)
                .top + (d.clickOffset || d.offset.click)
                .top, (d.positionAbs || d.position.absolute)
                .left + (d.clickOffset || d.offset.click)
                .left, l, f, c.proportions.height, c.proportions.width);
        case "touch":
    ...
    a.ui.ddmanager = {
        ...
        dragStart: function (d, c) {
            d.element.parents(":not(body,html)")
...
(function (a) {
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i)) {
                ...
                this.element.wrap(a('<div class="ui-wrapper" style="overflow: hidden;"></div>')
                    .css({
            ...
            this.handles = h.handles || (!a(".ui-resizable-handle", this.element)
                .length ? "e,s,se" : {
                n: ".ui-resizable-n",
                e: ".ui-resizable-e",
                s: ".ui-resizable-s",
            ...
            this._renderAxis = function (j) {
                ...
                for (var l in this.handles) {
                    if (this.handles[l].constructor == String) this.handles[l] = a(this.handles[l], this.element)
                        .show();
        ...
        _mouseStart: function (e) {
            ...
            h = a(".ui-resizable-" + this.axis)
                .css("cursor");
            a("body")
                .css("cursor", h == "auto" ? this.axis + "-resize" : h);
                ...
                f = {
                    ...
                    a(l)
                        ...
                        var n = a(this),
                            ...
                            m = {}, p = o && o.length ? o : n.parents(h.originalElement[0])
            ...
            var e = a(this)
                ...
                g = function (i) {
                    a(i)
                        ...
                        var b = a(this);
                        b.css({
                            position: b.data("resizable-alsoresize")
                                .position
                        })
                    })
                };
    ...
    a.ui.plugin.add("resizable", "containment", {
        start: function () {
            ...
            if (h = g instanceof a ? g.get(0) : /parent/.test(g) ? h.parent()
                .get(0) : g) {
        ...
        stop: function () {
            ...
            e._helper && !h.animate && /relative/.test(b.css("position")) && a(this)
                .css({
                left: j.left - i.left - g.left,
                width: l,
                height: f
            });
            e._helper && !h.animate && /static/.test(b.css("position")) && a(this)
                .css({
                left: j.left - i.left - g.left,
                width: l,
                height: f
            ...
            if (!this.options.disabled) {
                ...
                a(d.target)
                    ...
                    if (h) {
                        ...
                        h.$element.removeClass(g ? "ui-unselecting" : "ui-selected")
    ...
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseDrag: function (d) {
            ...
            if (this.options.scroll) {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
                    ...
                    if (d.pageY - a(document)
                        .scrollTop() < c.scrollSensitivity) e = a(document)
                        .scrollTop(a(document)
                        ...
                        .scrollTop(a(document)
                        .scrollTop() + c.scrollSpeed);
                    if (d.pageX - a(document)
                        .scrollLeft() < c.scrollSensitivity) e = a(document)
                        .scrollLeft(a(document)
        ...
        _getItemsAsjQuery: function (d) {
            ...
            if (h && d) for (d = h.length - 1; d >= 0; d--) for (var g = a(h[d]), i = g.length - 1; i >= 0; i--) {
                ...
                if (b && b != this && !b.options.disabled) e.push([a.isFunction(b.options.items) ? b.options.items.call(b.element) : a(b.options.items, b.element)
                    .not(".ui-sortable-helper")
                    .not(".ui-sortable-placeholder"), b])
            }
                ...
                e.placeholder = {
                    element: function () {
                        var g = a(document.createElement(c.currentItem[0].nodeName))
                            .addClass(h || c.currentItem[0].className + " ui-sortable-placeholder")
        ...
        _createHelper: function (d) {
            ...
            d.parents("body")
                .length || a(c.appendTo != "parent" ? c.appendTo : this.currentItem[0].parentNode)[0].appendChild(d[0]);
        ...
        _setContainment: function () {
            var d = this.options;
            if (d.containment == "parent") d.containment = this.helper[0].parentNode;
            if (d.containment == "document" || d.containment == "window") this.containment = [0 - this.offset.relative.left - this.offset.parent.left, 0 - this.offset.relative.top - this.offset.parent.top, a(d.containment == "document" ? document : window)
                .width() - this.helperProportions.width - this.margins.left, (a(d.containment == "document" ? document : window)
                .height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top];
        ...
        _clear: function (d, c) {
            ...
            if ((this.fromOutside || this.domPosition.prev != this.currentItem.prev()
                .not(".ui-sortable-helper")[0] || this.domPosition.parent != this.currentItem.parent()[0]) && !c) e.push(function (g) {
    ...
    a.effects.bounce = function (d) {
        return this.queue(function () {
            ...
            for (l = 0; l < b; l++) {
                ...
                o[j] = (g == "pos" ? "-=" : "+=") + i;
                n[j] = (g == "pos" ? "+=" : "-=") + i;
                c.animate(o, f / 2, d.options.easing)
                    .animate(n, f / 2, d.options.easing);
                i = h == "hide" ? i * 2 : i / 2
            }
            if (h == "hide") {
                l = {
                ...
                n[j] = (g == "pos" ? "+=" : "-=") + i;
                c.animate(o, f / 2, d.options.easing)
                    .animate(n, f / 2, d.options.easing, function () {
                    a.effects.restore(c, e);
                    a.effects.removeWrapper(c);
                    d.callback && d.callback.apply(this, arguments)
                })
...
(function (a) {
    a.effects.explode = function (d) {
        return this.queue(function () {
            ...
            d.options.mode = d.options.mode == "toggle" ? a(this)
            ...
            for (var i = h.outerWidth(true), b = h.outerHeight(true), f = 0; f < c; f++) for (var j = 0; j < e; j++) h.clone()
                .appendTo("body")
                .wrap("<div></div>")
                .css({
                position: "absolute",
...
(function (a) {
    a.effects.fold = function (d) {
        return this.queue(function () {
            ...
            a.effects.save(c, e);
            c.show();
            var f = a.effects.createWrapper(c)
                .css({
                overflow: "hidden"
            }),
                j = h == "show" != i,
            ...
            f.animate(i, b, d.options.easing)
                .animate(o, b, d.options.easing, function () {
                h == "hide" && c.hide();
                a.effects.restore(c, e);
                a.effects.removeWrapper(c);
                d.callback && d.callback.apply(c[0], arguments);
...
(function (a) {
    a.effects.shake = function (d) {
        return this.queue(function () {
            ...
            for (g = 1; g < i; g++) c.animate(l, b, d.options.easing)
                .animate(o, b, d.options.easing);
            c.animate(l, b, d.options.easing)
                .animate(h, b / 2, d.options.easing, function () {
                a.effects.restore(c, e);
                a.effects.removeWrapper(c);
                d.callback && d.callback.apply(this, arguments)
            });
...
(function (a) {
    a.widget("ui.accordion", {
        ...
        _create: function () {
            ...
            d.headers = d.element.find(c.header)
            ...
            if (c.navigation) {
                var e = d.element.find("a")
                    .filter(c.navigationFilter)
                    .eq(0);
                if (e.length) {
                    var h = e.closest(".ui-accordion-header");
                    d.active = h.length ? h : e.closest(".ui-accordion-content")
                        .prev()
                }
            }
            ...
            d.active.length ? d.active.attr({
                ...
                .attr("tabIndex", 0);
            a.browser.safari || d.headers.find("a")
                .attr("tabIndex", - 1);
            c.event && d.headers.bind(c.event.split(" ")
                .join(".accordion ") + ".accordion", function (g) {
        ...
        resize: function () {
            ...
            if (d.fillSpace) {
                ...
                c = this.element.parent()
                    .height();
                a.browser.msie && this.element.parent()
                    .css("overflow", e);
        ...
        animations: {
            slide: function (d, c) {
                ...
                if (d.toHide.size()) if (d.toShow.size()) {
                    ...
                    c = d.toShow;
                    b = c[0].style.width;
                    c.width(parseInt(c.parent()
                        .width(), 10) - parseInt(c.css("paddingLeft"), 10) - parseInt(c.css("paddingRight"), 10) - (parseInt(c.css("borderLeftWidth"), 10) || 0) - (parseInt(c.css("borderRightWidth"), 10) || 0));
...
(function (a) {
    a.widget("ui.menu", {
        ...
        move: function (d, c, e) {
            if (this.active) {
                d = this.active[d + "All"](".ui-menu-item")
                    .eq(0);
        ...
        nextPage: function (d) {
            if (this.hasScroll()) if (!this.active || this.last()) this.activate(d, this.element.children(".ui-menu-item:first"));
                ...
                var c = this.active.offset()
                    ...
                    h = this.element.children(".ui-menu-item")
                        .filter(function () {
                        var g = a(this)
                            .offset()
                            .top - c - e + a(this)
                ...
                this.activate(d, h)
            } else this.activate(d, this.element.children(".ui-menu-item")
...
(function (a) {
    var d, c, e, h, g = function () {
        ...
        var f = b.name,
            ...
            l = a([]);
        if (f) l = j ? a(j)
            .find("[name='" + f + "']") : a("[name='" + f + "']", b.ownerDocument)
            .filter(function () {
            return !this.form
        });
        return l
    ...
    a.widget("ui.button", {
        ...
        _create: function () {
            ...
            if (this.type === "checkbox") this.buttonElement.bind("click.button", function () {
                ...
                this.buttonElement.bind("mousedown.button", function () {
                    ...
                    if (f.disabled) return false;
                    if (o.keyCode == a.ui.keyCode.SPACE || o.keyCode == a.ui.keyCode.ENTER) a(this)
                        .addClass("ui-state-active")
                })
                ...
                this.buttonElement.is("a") && this.buttonElement.keyup(function (o) {
                    o.keyCode === a.ui.keyCode.SPACE && a(this)
                        .click()
                })
            }
        ...
        refresh: function () {
            ...
            if (this.type === "radio") i(this.element[0])
                .each(function () {
                a(this)
                    .is(":checked") ? a(this)
                    .button("widget")
    ...
    a.extend(c.prototype, {
        ...
        _attachments: function (b, f) {
            ...
            if (j == "button" || j == "both") {
                ...
                f.trigger = a(this._get(f, "buttonImageOnly") ? a("<img/>")
        ...
        _autoSize: function (b) {
            if (this._get(b, "autoSize") && !b.inline) {
                ...
                b.input.attr("size", this._formatDate(b, f)
                    .length)
            }
        },
        ...
        _destroyDatepicker: function (b) {
            ...
            if (f.hasClass(this.markerClassName)) {
                ...
                } else if (l == "div" || l == "span") f.removeClass(this.markerClassName)
                    .empty()
            }
        },
        _enableDatepicker: function (b) {
            ...
            if (f.hasClass(this.markerClassName)) {
                ...
                if (l == "input") {
                    ...
                    f.find("select.ui-datepicker-month, select.ui-datepicker-year")
                        .removeAttr("disabled")
                }
        ...
        _updateDatepicker: function (b) {
            ...
            j = f[1];
            b.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4")
                .width("");
            j > 1 && b.dpDiv.addClass("ui-datepicker-multi-" + j)
                .css("width", 17 * j + "em");
            ...
            if (b.yearshtml) {
                var l = b.yearshtml;
                setTimeout(function () {
                    l === b.yearshtml && b.yearshtml && b.dpDiv.find("select.ui-datepicker-year:first")
        ...
        _checkOffset: function (b, f, j) {
            var l = b.dpDiv.outerWidth(),
                ...
                m = document.documentElement.clientWidth + a(document)
                    .scrollLeft(),
                p = document.documentElement.clientHeight + a(document)
                    .scrollTop();
            f.left -= this._get(b, "isRTL") ? l - n : 0;
            f.left -= j && f.left == b.input.offset()
                .left ? a(document)
                .scrollLeft() : 0;
            f.top -= j && f.top == b.input.offset()
                .top + k ? a(document)
                .scrollTop() : 0;
        ...
        _tidyDialog: function (b) {
            b.dpDiv.removeClass(this._dialogClass)
                .unbind(".ui-datepicker-calendar")
        },
        _checkExternalClick: function (b) {
            if (a.datepicker._curInst) {
                b = a(b.target);
                b[0].id != a.datepicker._mainDivId && b.parents("#" + a.datepicker._mainDivId)
                    .length == 0 && !b.hasClass(a.datepicker.markerClassName) && !b.hasClass(a.datepicker._triggerClass) && a.datepicker._datepickerShowing && !(a.datepicker._inDialog && a.blockUI) && a.datepicker._hideDatepicker()
            }
        },
        ...
        _selectDay: function (b, f, j, l) {
            var o = a(b);
            if (!(a(l)
                .hasClass(this._unselectableClass) || this._isDisabledDatepicker(o[0]))) {
                o = this._getInst(o[0]);
                o.selectedDay = o.currentDay = a("a", l)
                    .html();
        ...
        parseDate: function (b, f, j) {
            ...
            if (j == -1) j = (new Date)
                .getFullYear();
            else if (j < 100) j += (new Date)
                .getFullYear() - (new Date)
                .getFullYear() % 100 + (j <= l ? 0 : -100);
            if (s > -1) {
                p = 1;
                q = s;
                do {
        ...
        formatDate: function (b, f, j) {
            ...
            case "D":
                ...
                break;
            case "o":
                q += m("o", Math.round(((new Date(f.getFullYear(), f.getMonth(), f.getDate()))
                    .getTime() - (new Date(f.getFullYear(), 0, 0))
                    .getTime()) / 864E5), 3);
                break;
            case "m":
        ...
        _determineDate: function (b, f, j) {
            var l = function (n) {
                ...
                var m = (n.toLowerCase()
                    .match(/^c/) ? a.datepicker._getDate(b) : null) || new Date,
                    p = m.getFullYear(),
                    q = m.getMonth();
                m = m.getDate();
        ...
        _getDaysInMonth: function (b, f) {
            return 32 - this._daylightSavingAdjust(new Date(b, f, 32))
                .getDate()
        },
...
(function (a, d) {
    ...
    a.widget("ui.dialog", {
        ...
        _create: function () {
            ...
            var g = this,
                ...
                j = (g.uiDialog = a("<div></div>"))
                    .appendTo(document.body)
                    .hide()
                    .addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + i.dialogClass)
                    .css({
                    zIndex: i.zIndex
                })
                    .attr("tabIndex", - 1)
        ...
        open: function () {
            if (!this._isOpen) {
                ...
                a(g.element.find(":tabbable")
                    .get()
                    .concat(b.find(".ui-dialog-buttonpane :tabbable")
                    .get()
                    .concat(b.get())))
                    .eq(0)
                    .focus();
        ...
        _createButtons: function (g) {
            var i = this,
                ...
                j = a("<div></div>")
                    ...
                    .appendTo(f);
            i.uiDialog.find(".ui-dialog-buttonpane")
                .remove();
        ...
        _setOption: function (g, i) {
            ...
            case "closeText":
                ...
                break;
            case "dialogClass":
                f.removeClass(b.options.dialogClass)
                    .addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + i);
                break;
            case "disabled":
            ...
            case "resizable":
                ...
                break;
            case "title":
                a(".ui-dialog-title", b.uiDialogTitlebar)
                    .html("" + (i || "&#160;"));
                break
            }
    ...
    a.extend(a.ui.dialog.overlay, {
            ...
            if (this.instances.length === 0) {
                setTimeout(function () {
                    a.ui.dialog.overlay.instances.length && a(document)
                        ...
                        if (a(b.target)
                            .zIndex() < a.ui.dialog.overlay.maxZ) return false
                    })
                }, 1);
                a(document)
                    .bind("keydown.dialog-overlay", function (b) {
        ...
        destroy: function (g) {
            ...
            this.instances.length === 0 && a([document, window])
...
(function (a, d) {
    a.widget("ui.progressbar", {
        ...
        _refreshValue: function () {
            ...
            this.valueDiv.toggle(c > this.min)
    ...
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _create: function () {
            ...
            if (c.range) {
                ...
                this.range = a("<div></div>")
                    .appendTo(this.element)
                    .addClass("ui-slider-range ui-widget-header" + (c.range === "min" || c.range === "max" ? " ui-slider-range-" + c.range : ""))
            }
            for (var i = e.length; i < h; i += 1) g.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");
            this.handles = e.add(a(g.join(""))
                .appendTo(d.element));
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length) this.handles.each(function (o) {
                ...
                a(this)
                    .stop(1, 1)[h ? "animate" : "css"](i, c.animate);
...
(function (a, d) {
    ...
    a.widget("ui.tabs", {
        ...
        _tabId: function (i) {
            return i.title && i.title.replace(/\s/g, "_")
                .replace(/[^\w\u00c0-\uFFFF-]/g, "") || this.options.idPrefix + c()
        },
        ...
        _tabify: function (i) {
            ...
            this.anchors.each(function (r, u) {
                var v = a(u)
                    ...
                    w = v.split("#")[0],
                    x;
                if (w && (w === location.toString()
                    .split("#")[0] || (x = a("base")[0]) && w === x.href)) {
                    v = u.hash;
                    u.href = v
                }
            ...
            if (i) {
                ...
                if (j.selected === d) {
                    ...
                    if (typeof j.selected !== "number" && this.lis.filter(".ui-tabs-selected")
                        .length) j.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"));
                ...
                if (j.selected >= 0 && this.anchors.length) {
                    f.element.find(f._sanitizeSelector(f.anchors[j.selected].hash))
            ...
            i = 0;
            for (var o; o = this.lis[i]; i++) a(o)[a.inArray(i, j.disabled) != -1 && !a(o)
            ...
            this.anchors.bind(j.event + ".tabs", function () {
                ...
                if (u.hasClass("ui-tabs-selected") && !j.collapsible || u.hasClass("ui-state-disabled") || u.hasClass("ui-state-processing") || f.panels.filter(":animated")
                    .length || f._trigger("select", null, f._ui(this, w[0])) === false) {
                    this.blur();
                    return false
                }
        ...
        load: function (i) {
            ...
            this.abort();
            if (!l || this.element.queue("tabs")
                .length !== 0 && a.data(j, "cache.tabs")) this.element.dequeue("tabs");
            else {
                this.lis.eq(i)
                    .addClass("ui-state-processing");
                if (f.spinner) {
                    var o = a("span", j);
                    o.data("label.tabs", o.html())
                        .html(f.spinner)
                }
                this.xhr = a.ajax(a.extend({}, f.ajaxOptions, {
                    url: l,
                    success: function (n, k) {
                        b.element.find(b._sanitizeSelector(j.hash))
                            .html(n);
                        b._cleanup();
        ...
        abort: function () {
            ...
            this.element.queue("tabs", this.element.queue("tabs")
                .splice(-2, 2));
            if (this.xhr) {
                this.xhr.abort();
                delete this.xhr
...
var Layout = function () {
    ...
    function advancedClick(e) {
        ...
        var search = $(this)
            .parents('#search');
        search.find('#advancedSearchOptions')
            .slideToggle();
    }
...
var Menu = function () {
    ...
    function init(config) {
        ...
        $menuContainer.each(function () {
            var parent = $(this)
                .parents('#quickNav'),
                cls = (parent.length > 0) ? $(this)
                    .addClass('menu-type-quicknav') : $(this)
                    .addClass('menu-type-topnav');
    ...
    function open(e) {
        ...
        $('#overlay')
            .bind('click', docClick);
        $modal.find('.menu-close')
            .bind('click', close);
        $(document)
            .bind('click.menu', docClick);
    }

    function docClick(e) {
        if ($(e.target)
            .parents('.menu-container')
            .length < 1) {
            if (!$(e.target)
                .is('.menu') && $(e.target)
                .parents('.menu')
    ...
    $.fn.visualize = function (options, container) {
        return $(this)
            ...
            var o = $.extend({
                ...
                width: $(this)
                    .width(), //height of canvas - defaults to table height
                height: $(this)
                    .height(), //height of canvas - defaults to table height
                        ...
                        if (drawHtml) {
                            ...
                            if (percentage) {
                                ...
                                var labeltext = $('<span class="visualize-label">' + labelval + '</span>')
                                    .css(leftRight, 0)
                                    .css(topBottom, 0);
                                if (labeltext) var label = $('<li class="visualize-label-pos"></li>')
                                    .appendTo(labels)
                                    .css({
                                    left: labelx,
                                    top: labely
            ...
            //get title for chart
            var title = o.title || self.find('caption')
                .text();
 ...
 * Tolltip by IraпїЅ Carvalho, irae@irae.pro.br, http://irae.pro.br/en/
 * Copyright (c) 2010 IraпїЅ Carvalho
 * Dual licensed under the MIT (filamentgroup.com/examples/mit-license.txt) and GPL (filamentgroup.com/examples/gpl-license.txt) licenses.
 * 	
...
(function ($) {
    $.visualizePlugins.push(function visualizeTooltip(options, tableData) {
        ...
        var tooltip = $('<div class="' + o.tooltipclass + '"/>')
            .css({
            position: 'absolute',
            display: 'none',
            zIndex: 90
...
(function (a) {
    a.uniform = {
        options: {
            ...
            fileBtnClass: "action",
            fileDefaultText: "Р¤Р°Р№Р» РЅРµ РІС‹Р±СЂР°РЅ",
            fileBtnText: "Р’С‹Р±СЂР°С‚СЊ С„Р°Р№Р»",
            ...
            a(n)
                ...
                "click.uniform touchend.uniform": function () {
                    if (!a(n)
                        ...
                        a("." + p + " span." + k.checkedClass + ":has([name='" + a(n)
                            .attr("name") + "'])")
    ...
    $.extend(Timepicker.prototype, {
        ...
        _rebindDialogEvents: function (inst) {
            ...
            .find('.ui-timepicker-minute-cell')
                ...
                $(this)
                    .removeClass('ui-state-hover');
                if (this.className.indexOf('ui-timepicker-prev') != -1) $(this)
                    .removeClass('ui-timepicker-prev-hover');
                if (this.className.indexOf('ui-timepicker-next') != -1) $(this)
                    .removeClass('ui-timepicker-next-hover');
            })
                ...
                if (!self._isDisabledTimepicker(inst.inline ? inst.tpDiv.parent()[0] : inst.input[0])) {
                    ...
                    $(this)
                        .addClass('ui-state-hover');
                    if (this.className.indexOf('ui-timepicker-prev') != -1) $(this)
                        .addClass('ui-timepicker-prev-hover');
                    if (this.className.indexOf('ui-timepicker-next') != -1) $(this)
                        .addClass('ui-timepicker-next-hover');
                }
            })
                .end()
        ...
        _updateMinuteDisplay: function (inst) {
            ...
            inst.tpDiv.find('td.ui-timepicker-minutes')
                .html(newHtml);
            this._rebindDialogEvents(inst);
            // after the picker html is appended bind the click & double click events (faster in IE this way
            // then letting the browser interpret the inline events)
...
*/
        ...
        _checkOffset: function (inst, offset, isFixed) {
            ...
            var viewWidth = document.documentElement.clientWidth + $(document)
                .scrollLeft();
            var viewHeight = document.documentElement.clientHeight + $(document)
                .scrollTop();
        ...
        _checkExternalClick: function (event) {
            ...
            if ($target[0].id != $.timepicker._mainDivId && $target.parents('#' + $.timepicker._mainDivId)
                .length == 0 && !$target.hasClass($.timepicker.markerClassName) && !$target.hasClass($.timepicker._triggerClass) && $.timepicker._timepickerShowing && !($.timepicker._inDialog && $.blockUI)) $.timepicker._hideTimepicker();
        },
        ...
        selectNow: function (e) {
            ...
            var id = $(e.target)
                .attr("data-timepicker-instance-id"),
                $target = $(id),
...
(function (m, ma) {
    ...
    function Yb(a, b, e) {
        ...
        function y(k) {
            if (!n || k != n.name) {
                ...
                else n = Y[k] = new Ja[k](Z = s = m("<div class='fc-view fc-view-" + k + "' style='position:absolute'/>")
                    .appendTo(E), X);
    ...
    function Zb(a, b) {
        function e() {
            q = b.theme ? "ui" : "fc";
            if (b.header) return Q = m("<table class='fc-header' style='width:100%'/>")
                .append(m("<tr/>")
                .append(f("left"))
                .append(f("center"))
                .append(f("right")))
    ...
    function Rb(a, b, e) {
        ...
        function g() {
            ...
            ja = m("<div style='position:absolute;z-index:2;left:0;width:100%'/>")
                .appendTo(a);
            if (i("allDaySlot")) {
                ia = m("<div style='position:absolute;z-index:8;top:0;left:0'/>")
                    .appendTo(ja);
            ...
            w = m("<div style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>")
                .appendTo(ja);
        ...
        function fa(h) {
            if (!i("selectable")) {
                var O = Math.min(Ba - 1, Math.floor((h.pageX - v.offset()
                    .left - Ma) / db)),
                    x = ua(O),
        ...
        Na = new Nb(function (h, O) {
            ...
            for (var Da = I.offset()
                .top, Ea = w.offset()
                .top, tc = Ea + w.outerHeight(), fb = 0; fb < tb; fb++) h.push([x(Da + Xa * fb), x(Da + Xa * (fb + 1))])
        });
        Ra = new Ob(Na);
                ...
                stop: function ($, w) {
                    ...
                    if (J) {
                        ...
                        M || (I = Math.round((s.offset()
                            .top - X()
                            .offset()
                            .top) / ia) * u("slotMinutes") + la - (o.start.getHours() * 60 + o.start.getMinutes()));
                        C(this, o, k, I, M, $, w)
                    }
                }
            })
    ...
    function Mb() {
        ...
        var g = f.opt,
            ...
            y = f.clearSelection,
            S = false;
        g("selectable") && g("unselectAuto") && m(document)
    ...
    function Pb(a) {
        ...
        var e = this,
            d = {}, f = {}, g = {};
        e.left = function (l) {
            return f[l] = f[l] === ma ? b(l)
                .position()
                .left : f[l]
        };
        e.right = function (l) {
            return g[l] = g[l] === ma ? e.left(l) + b(l)
                .width() : g[l]
        };
        e.clear = function () {
            d = {};
...
(function ($) {
    ...
    $.fn.tipsy.elementOptions = function (ele, options) {
        return $.metadata ? $.extend({}, options, $(ele)
            .metadata()) : options;
    };
    ...
    $.fn.tipsy.autoBounds = function (margin, prefer) {
        return function () {
            ...
            if ($this.offset()
                .top < boundTop) dir.ns = 'n';
            if ($this.offset()
                .left < boundLeft) dir.ew = 'w';
            if ($(window)
                .width() + $(document)
                .scrollLeft() - $this.offset()
                .left < margin) dir.ew = 'e';
            if ($(window)
                .height() + $(document)
        ...
        _required: function (field, rules, i, options) {
            ...
            case "checkbox":
                ...
                if (form.find("input[name='" + name + "']:checked")
                    ...
                    if (form.find("input[name='" + name + "']")
                        .size() == 1) return options.allrules[rules[i]].alertTextCheckboxe;
            ...
            case "select-multiple":
                ...
                if (!field.find("option:selected")
                    .val()) return options.allrules[rules[i]].alertText;
                break;
            }
        },
        /**
 ...
 */ (function ($) {
    $.fn.lightBox = function (settings) {
        settings = jQuery.extend({
            ...
            imageLoading: '/img/admin/lightbox/lightbox-ico-loading.gif',
            imageBtnPrev: '/img/admin/lightbox/lightbox-btn-prev.gif',
            imageBtnNext: '/img/admin/lightbox/lightbox-btn-next.gif',
            imageBtnClose: '/img/admin/lightbox/lightbox-btn-close.gif',
            imageBlank: '/img/admin/lightbox/lightbox-blank.gif',
        ...
        function _resize_container_image_box(intImageWidth, intImageHeight) {
            var intCurrentWidth = $('#lightbox-container-image-box')
                .width();
            var intCurrentHeight = $('#lightbox-container-image-box')
                .height();
    ...
    mapMarkers: function (center, markers) {
        ...
        for (i = 0; i < markers.length; i++) {
            ...
            if (markers[i].info) {
                ...
                $(markers[i].info.layer)
                    .hide();
                // Marker Div Layer Exists
                if (markers[i].info.popup)
                // Map Marker Shows an Info Box on Load
                $.googleMaps.marker[i].openInfoWindowHtml($(markers[i].info.layer)
                    .html());
                else $.googleMaps.marker[i].bindInfoWindowHtml($(markers[i].info.layer)
                    .html()
                    .toString());
            }
        }
...
var ChartHelper = function () {
    ...
    function visualize(config) {
        config.el.each(function () {
            visualizeChartHeight = ($(this)
                .attr('data-chart-height') != null) ? $(this)
                .attr('data-chart-height') + 'px' : visualizeChartHeight;
            visualizeChartType = ($(this)
                .attr('data-chart-type') != null) ? $(this)
                .attr('data-chart-type') : visualizeChartType;

            visualizeChartWidth = $(this)
                .parent()
                .width() * .92;
...
$(function () {
    ...
    if ($('.chartHelperChart')
        .length < 1) {
        $(document)
            .unbind('layout.resize');
    }

    $('.uniformForm')
        .find("select, input:checkbox, input:radio, input:file")
        .uniform();
    ...
    $('#reveal-nav')
        .live('click', toggleNav);

    $('.notify')
        .find('.close')
        .live('click', notifyClose);
