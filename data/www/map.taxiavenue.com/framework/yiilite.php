...

{
...

	{
...

		{
			...
			throw new CHttpException(404,Yii::t('yii','(1)Unable to resolve the request "{route}".',
...

	{
...

		{
			...
			if($this->useStrictParsing)
				...
				throw new CHttpException(404,Yii::t('yii','(2)Unable to resolve the request "{route}".',
